            ...
            if (listaHome) {
                ...
                if (receitas.length === 0) {
                    ...
                    receitas.slice(0, 3).forEach(receita => {
                        ...
                        const iconeReceita = receita.iconeCategoria || 'savings'; // Usar ícone da categoria ou fallback
                        div.innerHTML = `
            ...
            if (listaHome) {
                ...
                if (despesas.length === 0) {
                    ...
                    despesas.slice(0, 3).forEach(despesa => {
                        ...
                        const iconeDespesa = despesa.iconeCategoria || 'shopping_cart'; // Usar ícone da categoria ou fallback
                        div.innerHTML = `
    ...
    if (labels.length > 0) {
        ...
        if (listaCategorias) {
            ...
            labelsOrdenadas.forEach((cat, idx) => {
                ...
                const icone = categoriaIcones[cat] || 'category';
