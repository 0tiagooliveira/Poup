document.addEventListener('DOMContentLoaded', function() {
    ...
    const bancosDisponiveis = [
        ...
        { nome: 'Banco do Brasil', codigo: '001', cor: '#FFEF38', icone: '../Icon/banco-do-brasil.svg' },
        ...
        { nome: 'Caixa', codigo: '104', cor: '#0070AF', icone: '../Icon/caixa.svg' },
        { nome: 'PicPay', codigo: '380', cor: '#21C25E', icone: '../Icon/picpay.svg' }
    ];
