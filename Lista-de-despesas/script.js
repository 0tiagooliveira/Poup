...
/* Removida função setupDropdownAndFilters - usando header-padrao.js */

/* Função createDropdown removida - dropdown agora está no HTML */

/* Função hideDropdown removida - usando fecharDropdown() do header-padrao.js */
    ...
    if (!despesas || despesas.length === 0) {
        container.innerHTML = `
            <div class="estado-vazio">
                ...
                <p>Comece registrando suas despesas para controlar seus gastos financeiros</p>
                <div class="acoes-sugeridas">
                    <a href="../Nova-Despesa/Nova-Despesa.html" class="acao-rapida">
...
function createDespesaItem(despesa) {
    ...
    if (despesa.iconeCategoria && despesa.corCategoria) {
        console.log(`✅ [DESPESA ${despesa.id}] Usando ícone personalizado:`, despesa.iconeCategoria, despesa.corCategoria);
        ...
        console.log(`⚠️ [DESPESA ${despesa.id}] Usando ícone do mapeamento para "${categoriaKey}":`, categoryInfo.icon, categoryInfo.background);
        icon = categoryInfo.icon;
        background = categoryInfo.background;
    }
    
    console.log(`📌 Ícone final usado: ${icon}, Cor final: ${background}`);
...
/* Removidas funções duplicadas do dropdown - usando header-padrao.js */