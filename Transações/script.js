...
function updateMonthDisplay() {
    ...
    if (mesAtualElement) {
        ...
        console.error('Elemento mes-atual não encontrado');
    }
}
    ...
    if (!transacoes || transacoes.length === 0) {
        lista.innerHTML = `
            <div class="estado-vazio">
                ...
                <p>Adicione receitas, despesas ou transferências para começar a controlar suas finanças</p>
                <div class="acoes-sugeridas">
                    <a href="../Nova-Receita/Nova-Receita.html" class="acao-rapida">
                        <span class="material-icons-round">trending_up</span>
                        Adicionar Receita
                    </a>
                    <a href="../Nova-Despesa/Nova-Despesa.html" class="acao-rapida secundaria">
